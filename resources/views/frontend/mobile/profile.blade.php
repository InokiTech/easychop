...
<style>
        ...
        .editprofile-details-section h1{
...
<main>
{{$success ?? ''}}
    <section class="editprofile-details-section">
        <h1>Edit profile</h1>
        <form action="{{url('/customer/profile')}}" id="formData" method="POST" class="editprofile-details-form">
            @csrf
            ...
            <div class="form-group btn-wrapper col-md-12">
...
<script>
    ...
    formElem.onsubmit = async (e) => {
        ...
        let count = await fetch(`/customer/profile`, {
                method: 'POST',
