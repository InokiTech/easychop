                                    ...
                                    <td><img class="img-fluid rounded-circle" width="40px" src="{{($user->avatar)? $user->avatar : asset('uploads/avatar/avatar.png')}}" alt="icon"></td>
                                        ...
                                        <div class="d-inline-block">
                                          <div class="dropdown">
                                            ...
                                            <a href="{{route('impersonate',$user->id)}}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="impersonate user"><i class="fa text-white fa-user-secret"></i></a>
                                        ...
                                        <div class="d-inline-block">
                                          <a href="{{route('user.edit',$user->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit" data-toggle="tooltip"  data-placement="bottom" title="Edit User"></i></a>
                                        </div>
                                        <div class="d-inline-block">
                                          @if($user->username != 'admin')
                                          <form action="{{route('user.destroy',$user->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteUser"><i class='fa fa-trash'></i></button>
